...
if __name__ == "__main__":
    ...
    evaluation_plan = [{'type': 'push', 'aggregate': 'B', 'targetEtype': 'A', 'targetSinkType': 'SiSi', 'targetNode': 2}, {'type': 'push', 'aggregate': 'D', 'targetEtype': 'C', 'targetSinkType': 'MuSi', 'targetNode': None}, {'type': 'aggr', 'aggregate': 'AB', 'targetEtype': 'C', 'sendRateEtype': 'B', 'sourceEtype': 'A', 'targetSinkType': 'MuSi', 'sourceSinkType': 'SiSi', 'targetNode': None, 'sourceNode': 2}, ['SEQ(AB_B,C,D)', True, 'C', 'D']]
